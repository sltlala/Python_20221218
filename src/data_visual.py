...
def gangweishuliang_hist():  # 主函数调用的 gangweishuliang_hist()函数
	...
	jobs = ['产品经理', '产品助理', '交互设计', '前端开发', '软件设计', 'IOS开发', '业务分析', '安卓开发', 'PHP开发', '业务咨询', '需求分析', '流程设计', '售后经理',
	        '售前经理', '技术支持', 'ERP实施', '实施工程师', 'IT项目经理', 'IT项目助理', '信息咨询', '数据挖掘', '数据运营', '数据分析', '网络营销', '物流与供应链',
	...
	for each_result in results:
		for i in range(0, 30):
			if each_result[0] == jobs[i]:
				count[i] += 1
				continue  # 计算每种岗位的数量
	jobs_classification = ['技术管理类', 'IT运维类', '技术开发类', '业务咨询类', '技术支持类', '数据运营类', '市场职能类', '产品运营类',
...
def post_salary():  # 主函数调用的 post_salary()函数
	...
	T1 = ['产品经理', '产品助理', '交互设计']
	T2 = ['前端开发', '软件设计', 'IOS开发', '业务分析', '安卓开发', 'PHP开发']
	C1 = ['业务咨询', '需求分析', '流程设计']
	C2 = ['售后经理', '售前经理', '技术支持', 'ERP实施', '实施工程师']
	C3 = ['IT项目经理', 'IT项目助理']
	D1 = ['信息咨询', '数据挖掘']
	D2 = ['数据运营', '数据分析']
	P1 = ['网络营销', '物流与供应链', '渠道管理']
